...
export const DEPARTMENT_DATA: Record<DepartmentId, DepartmentStaticData> = {
  justice: {
    ...
    shareImage: '/static/share/audrey.png',
  ...
  hangedman: {
    ...
    shareImage: '/static/share/alger.png',
  ...
  sun: {
    ...
    shareImage: '/static/share/derrick.png',
  ...
  magician: {
    ...
    shareImage: '/static/share/fors.png',
  ...
  moon: {
    ...
    shareImage: '/static/share/emlyn.png',
  ...
  hermit: {
    ...
    shareImage: '/static/share/cattleya.png',
  ...
  star: {
    ...
    shareImage: '/static/share/leonard.png',
  ...
  judgement: {
    ...
    shareImage: '/static/share/xio.png',
